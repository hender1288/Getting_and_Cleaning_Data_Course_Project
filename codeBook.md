...
|Time.BodyAngularSpeed-std()-X|
|Time.BodyAngularSpeed-std()-Y|
|Time.BodyAngularSpeed-std()-Z|
|Time.BodyAngularSpeedJerk-mean()-X|
|Time.BodyAngularSpeedJerk-mean()-Y|
|Time.BodyAngularSpeedJerk-mean()-Z|
|Time.BodyAngularSpeedJerk-std()-X|
|Time.BodyAngularSpeedJerk-std()-Y|
|Time.BodyAngularSpeedJerk-std()-Z|
...
|Time.BodyAngularSpeedMagnitude-std()|
|Time.BodyAngularSpeedJerkMagnitude-mean()|
|Time.BodyAngularSpeedJerkMagnitude-std()|
...
|Frequency.BodyAngularSpeed-std()-X|
|Frequency.BodyAngularSpeed-std()-Y|
|Frequency.BodyAngularSpeed-std()-Z|
...
|Frequency.BodyBodyAngularSpeedMagnitude-std()|
|Frequency.BodyBodyAngularSpeedJerkMagnitude-mean()|
|Frequency.BodyBodyAngularSpeedJerkMagnitude-std()|
